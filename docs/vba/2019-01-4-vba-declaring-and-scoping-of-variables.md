---
id: vba-variables-decl
title: Declaring and Scoping of Variables
---

If you read the previous topics, you now know a bit about [Variables](vba-variables) and [Data-types](vba-prog-concept#data-types-in-vba). 
