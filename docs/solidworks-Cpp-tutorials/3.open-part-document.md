...
![new-project-window](../../static/assets/solidworks-cpp-images/open-part-document/new-project-window.png)

If you want to know more detail for Creating a New Project in Visual Studio, please visit **[Create a New project](sw-cpp-open#create-a-new-project)** section of **[Solidworks C++ API - Open Solidworks & Hello World](sw-cpp-open)** post.
...
I have already explain each steps taken to create/add a "**Source.cpp**" into our project in **[Add Source file](sw-cpp-open#add-source-file)** section of **[Solidworks C++ API - Open Solidworks & Hello World](sw-cpp-open)** post.
...
This section is copy/paste from **[Solidworks C++ API - Open Solidworks & Hello World](sw-cpp-open)** post.
...
![open-property-window](../../static/assets/solidworks-cpp-images/open-solidworks/open-property-window.png)

This will open a new window as shown in below image.

![project-property-window](../../static/assets/solidworks-cpp-images/open-solidworks/project-property-window.png)
...
![add-solidowrks-reference](../../static/assets/solidworks-cpp-images/open-solidworks/add-solidowrks-reference.png)
...
![build-solution](../../static/assets/solidworks-cpp-images/open-solidworks/build-solution.png)
...
![open-part-window](../../static/assets/solidworks-cpp-images/open-part-document/open-part-window.png)
...
![default-template-locations](../../static/assets/solidworks-cpp-images/open-part-document/default-template-locations.png)
