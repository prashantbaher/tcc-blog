---
id: sw-sketch-macro-offset-entities
...
**CapEnds** : *Cap the ends as defined by `swSkOffsetCapEndType_e`*
  ...
  `swSkOffsetCapEndType_e` enum defines following different **End cap types** [constants](../vba/vba-constants):
...
**MakeConstruction** : *Convert original and offset sketch entities to construction sketch entities as defined by `swSkOffsetMakeConstructionType_e`*
  ...
  `swSkOffsetMakeConstructionType_e` enum defines following different **Construction Types** [constants](../vba/vba-constants):
