---
id: sw-sketch-macro-create-perimeter-circle
title:  Create Perimeter Circle
---

In this post, I tell you about *how to create Perimeter Circle through Solidworks VBA Macros* in a sketch.

The process is identical with previous **[Solidworks Sketch Macros - Create Circle](sw-sketch-macro-create-circle)** post.
