---
id: sw-macro-open-saved-documents
...
I have already explained every line except *middle line* in above code sample in previous [posts](sw-macro-open-part).
...
For more details about *Options* parameters, please visit [this page](https://help.solidworks.com/2017/english/api/swconst/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swOpenDocOptions_e.html
).
