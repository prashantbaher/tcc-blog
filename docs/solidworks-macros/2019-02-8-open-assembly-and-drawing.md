---
id: sw-macro-open-asm-and-dwg
title:  Open Assembly and Drawing document
---
...
As you can see in the above code and the code is given in the **[previous post](sw-macro-open-part)** is almost identically.

In case you have not read my previous post **([Solidworks Macros - Open new Part document](sw-macro-open-part))**, I recommend you to read that post first. 
...
## Open Drawing Document without Paper size
...
## Open Drawing Document with Default Paper size
...
## Open Drawing Document with Custom Paper size
