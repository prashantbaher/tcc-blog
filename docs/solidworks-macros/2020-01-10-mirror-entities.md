---
id: sw-sketch-macro-mirror-sketch-entities
title:  Mirror Sketch Entities 
---
...
For more information about `CreateCenterLine` method, you can read my **[Solidworks Sketch Macros - Create CenterLines](sw-sketch-macro-create-line)** post.
