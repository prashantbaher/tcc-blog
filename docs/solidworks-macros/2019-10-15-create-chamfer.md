---
id: sw-sketch-macro-create-chamfer
title:  Create a Chamfer
---

In this post, I tell you about *how to create a Chamfer through Solidworks VBA Macros* in a sketch.

This post is an extension of **[Sketch - Create Corner Rectangle](sw-sketch-macro-create-corner-rec)** post.
...
For detail explaination on `CreateCornerRectangle` method, please see **[Sketch - Create Corner Rectangle](sw-sketch-macro-create-corner-rec)** post.
