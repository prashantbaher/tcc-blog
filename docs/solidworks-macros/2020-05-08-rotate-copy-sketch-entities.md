---
id: sw-sketch-macro-rotate-or-copy-sketch-entities
title:  Rotate/Copy Sketch Entities
---
...
This post is similar to previous **[Sketch Transformation - Move/Copy Sketch Entities](sw-sketch-macro-move-or-copy-sketch-entities)** post.

If you have not visited my previous **[Sketch Transformation - Move/Copy Sketch Entities](sw-sketch-macro-move-or-copy-sketch-entities)** post, then please do check-it if you want to learn Move/Copy Sketch Entities from VBA Macros.
...
If you want to know more about `CreateCenterRectangle` method, then please visit **[Sketch - Create Center Rectangle](sw-sketch-macro-create-center-rec)** post.
...
Since we are creating sketch in **X-Y plane**, hence I used values mentioned in *[Destination Point Values](sw-sketch-macro-rotate-or-copy-sketch-entities#destination-point-values)* section of this post.
...
Since we are creating sketch in **X-Y plane**, hence I used values mentioned in *[Destination Point Values](sw-sketch-macro-rotate-or-copy-sketch-entities#destination-point-values)* sections of this post.
