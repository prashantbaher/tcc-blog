---
id: sw-sketch-macro-split-sketch-entities
title:  Split Open/Closed Sketch Entities
---
...
For more information about `CreateCircle` method, you can read my **[Solidworks Macro - Create Circle From VBA Macro](sw-sketch-macro-create-circle)** post.
...
For more information about `CreateLine` method, you can read my **[Solidworks Sketch Macro - Create Line](sw-sketch-macro-create-line)** post.
