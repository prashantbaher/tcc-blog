---
id: sw-sketch-macro-create-corner-rec
title:  Create Corner Rectangle
---

In this post, I tell you about *how to create Corner Rectangle through Solidworks VBA Macros* in a sketch.

For this, I take the example from previous **[Sketch - Create Lines](sw-sketch-macro-create-line)** post.
