...
Most of the things in this code sample is already explained in **([Solidworks Macros - Open new Part document](sw-macro-open-part))** post and in previous section of this very post.
