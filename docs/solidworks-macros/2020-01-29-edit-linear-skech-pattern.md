---
id: sw-sketch-macro-edit-linear-sketch-patterm
title:  Edit Linear Sketch Pattern
---

In this post, I tell you about **how to Edit Linear Sketch Pattern using Solidworks VBA Macros** in a Sketch.

This post is extension of previous **[Solidworks Macro - Linear Sketch Pattern From VBA Macro](sw-sketch-macro-linear-sketch-patterm)** post.

I recommend you to read **[Solidworks Macro - Linear Sketch Pattern From VBA Macro](sw-sketch-macro-linear-sketch-patterm)** post because we are using same code sample.
...
Since this post is *an extension* of previous **[Solidworks Macro - Linear Sketch Pattern From VBA Macro](sw-sketch-macro-linear-sketch-patterm)** post, then I will start explaining from **Last line** only.

If you want to understand every line of code, then please visit **[Solidworks Macro - Linear Sketch Pattern From VBA Macro](sw-sketch-macro-linear-sketch-patterm)** post "first", then read this post.
...
In my previous **[Solidworks Macro - Linear Sketch Pattern From VBA Macro](sw-sketch-macro-linear-sketch-patterm)** post, we created a Linear pattern *3 instances* in *x-direction*.
