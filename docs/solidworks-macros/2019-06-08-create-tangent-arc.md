---
id: sw-sketch-macro-create-tangent-arc
title:  Create Tangent Arc
---
...
For detailed information on *Creating Sketch Line* visit **[Solidworks Sketch Macros - Create Line](sw-sketch-macro-create-line)**.
