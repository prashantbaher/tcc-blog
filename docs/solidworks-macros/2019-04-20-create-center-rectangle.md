---
id: sw-sketch-macro-create-center-rec
title:  Create Center Rectangle
---

In this post, I tell you about *how to create Center Rectangle through Solidworks VBA Macros* in a sketch.

The process is almost identical with previous **[Solidworks Macros - Create Corner Rectangle](sw-sketch-macro-create-corner-rec)** post.
