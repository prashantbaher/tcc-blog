...
title:  Solidworks Macro - Create 3-Point Corner Rectangle From VBA Macro
...
The process is almost identical with previou [Solidworks Macros - Create Corner Rectangle From VBA Macro](/solidworks-macro/create-corner-rectangle) post.
